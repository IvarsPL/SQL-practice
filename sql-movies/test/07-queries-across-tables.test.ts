...
describe("Queries Across Tables", () => {
  ...
  it(
    ...
    async done => {
      const query = `select keyword, count(keyword_id) as count from keywords
  ...
  it(
    ...
    async done => {
      const query = `select movies.original_title, count(actor_id) as count from movies
  ...
  it(
    ...
    async done => {
      const query = `select genre, count (genre) as five_stars_count from genres
